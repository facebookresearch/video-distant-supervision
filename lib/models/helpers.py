...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, img_size=224, num_frames=8, num_patches=196, attention_type='divided_space_time', pretrained_model="", strict=True, pre_num=0):
    if cfg is None:
    ...
    elif num_classes != state_dict[classifier_name + '.weight'].size(0) and pre_num == 0:
